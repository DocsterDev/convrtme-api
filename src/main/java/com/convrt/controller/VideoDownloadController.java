...
public class VideoDownloadController {
    ...
    @GetMapping("{videoId}/test-download")
    public void testDownload(@PathVariable("videoId") String videoId) {
        log.info("Test download request for video {}", videoId);
        appManagedDownload.startDownload(String.format("https://www.youtube.com/watch?v=%s", videoId));
    }
